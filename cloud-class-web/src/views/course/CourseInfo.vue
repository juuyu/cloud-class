    ...
    <el-main style="margin: 30px auto;width: 65%">
      ...
      <el-tabs type="card" @tab-click="handlerClick" v-model="activeTap">
        ...
        <el-tab-pane name="courseJob">
          ...
          />
          <el-empty description="暂无课程作业" v-show="jobList.length === 0"/>
        </el-tab-pane>
...
import {ArrowLeft, Folder, House, Notebook, User, VideoCamera,} from '@element-plus/icons-vue'
import {useRoute} from "vue-router";
import {getData} from "~/api/main";
import {ElMessage, TabsPaneContext} from "element-plus";
import DataCourse from "~/components/data/course/data-course.vue";
import localCache from "~/utils/cache";
import TableUser from "~/components/table/user/table-user.vue";
...
const activeTap = ref("courseInfo")
